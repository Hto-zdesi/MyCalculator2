...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.clear).setOnClickListener((view) -> onClearClick());
        findViewById(R.id.percent).setOnClickListener((view) -> onPercentClick());
    ...
    private void onPercentClick() {
        ...
        if (!number.isEmpty()) {
            ...
            numberField.setText(String.valueOf(percent));
            resultField.setText("");
        }
    }
